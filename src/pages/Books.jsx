...
const Books = () => {
  ...
  if (loading) {
    ...
    return (
      <div className="container bg-custom">
       <Breadcrumb/>
        <div className="text-center mb-10 max-w-[400px] mx-auto bg-custom">
  ...
  return (
    ...
    <Breadcrumb></Breadcrumb>
      ...
      <div className=''>
      <div className='grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 place-items-center gap-5  '>{ books.map((book) => <div key={book.id}>
      <Link  to={`/books/${book.id}`}>
      <div className=' p-7 rounded-2xl shadow-lg max-md:px-5 w-[200px] h-[350px]  ml-1'>
      <div className=' '><img src={book.
        cover_image}  className='h-[180px] bg-slate-300 w-[200px] ml-0 '></img>
        
        </div>
        <div className=' mt-3'><div className=' text-center text-indigo-800 font-medium h-24'>{book.title}</div>
         </div>
