...
const Contact = () => {
  ...
  return (
    ...
    <h2 className="text-2xl text-indigo-800 font-semibold mb-4">Contact Us</h2>
    <Formik
    ...
    >
      {({ isSubmitting }) => (
        <Form className="space-y-4">
          <div>
            <label htmlFor="user_name" className="block text-sm font-medium text-gray-700 mt-8">
              Name*
            </label>
            <Field
              type="text"
          ...
          <div>
            <label htmlFor="user_email" className="block  mt-5 text-sm font-medium text-gray-700">
              Email*
            </label>
            <Field
              type="email"
          ...
          <div>
            <label htmlFor="message" className="block text-sm font-medium text-gray-700 mt-5">
              Message*
            </label>
            <Field
              as="textarea"
